...
#define INPUT 2  // ここの値を変えると処理方法が変えられるよ！
...
//================================================================
    ...
    // 例えば、sscanf("%d-%d", &a, &b); として、「123-456」と入力した場合、変数aに123、変数bに456と代入される
...
//================================================================
    ...
    for (int i = 0; i < L; i++) {
        ...
        // jが"5"になった時点で、{}内のプログラムが実行されずにループを抜ける（'A'に"3"列目は存在しない）
    }
